...
# Group by scenario/protocol and compute mean overhead
df_grouped = (
    df.groupby(["scenario_label", "protocol"], as_index=False)["avg_overhead"]
      .mean()
)
...
out_path = "../charts/communication_overhead_bar_chart.png"
